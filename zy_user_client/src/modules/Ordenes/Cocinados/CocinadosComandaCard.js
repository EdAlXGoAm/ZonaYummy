...
const CocinadosComandaCard = ({Comanda, updateComanda, compact = false, comandaNumber = null}) => {
    ...
    return (
        <div
            ref={debugCardRef}
            className={`resume-card ${compact ? 'resume-card--compact' : ''} ${isHamburguesa ? 'resume-card--hamburguesa' : ''} ${isEditing ? 'resume-card--editing' : ''}`}
        ...
        >
            ...
            <div className="card-body mb-1 divStyle" style={{backgroundColor: colorStatus, ...(isPending ? {fontFamily: 'Arial, sans-serif'} : {})}}>
                ...
                <div className="row">
                    <div className='col'>
                        {isEditing ? (
                            <div className="comanda-editing-banner">
                                <span>Editando Comanda...</span>
                            </div>
                        )
                        : (
                            <div>
