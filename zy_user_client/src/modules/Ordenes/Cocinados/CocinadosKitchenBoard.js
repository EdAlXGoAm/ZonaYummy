...
import CocinadosComandaCard from './CocinadosComandaCard';
import { DebugCardHeightShell } from './CocinadosDebugCardHeight';
import {
...
import './CocinadosKitchenBoard.css';
...
const CocinadosKitchenBoard = ({modeInterface, Orders}) => {
            ...
            >
                ...
                <div className="order-column-body">
                    {order.comandas.map((comanda, comandaIndex) => (
                        ...
                        >
                            <CocinadosComandaCard Comanda={comanda} compact comandaNumber={comanda.ComandaId} />
                        </div>
                    ))}
                </div>
            </div>
...
export default CocinadosKitchenBoard;
